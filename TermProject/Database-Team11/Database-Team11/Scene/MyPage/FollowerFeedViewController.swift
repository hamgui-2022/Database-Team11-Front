//
//  FollowerFeedViewController.swift
//  Database-Team11
//
...
class FollowerFeedViewController: UIViewController {
...
extension FollowerFeedViewController: UITableViewDelegate, UITableViewDataSource {
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return FeedComment.data2.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dataObject = FeedComment.data2[indexPath.row]
...
extension FollowerFeedViewController: UITextViewDelegate {
